	...
	*/
				...
				Handler.extend({
					...
					string: function (t) {
						...
						if (t.template.length) {
							for (
								void 0 == t.rule.count && (o += t.template), e = 0;
								e < t.rule.count;
								e++
							)
								o += t.template;
							for (
								n = o.match(Constant.RE_PLACEHOLDER) || [], e = 0;
								e < n.length;
								e++
							)
				...
				Handler.extend({
					...
					getValueByKeyPath: function (t, e) {
						...
						"/" === t.charAt(0)
							...
							: r.length > 1 &&
							  ((a = e.context.path.slice(0)),
							  a.pop(),
							  (a = this.normalizePath(a.concat(r))));
						try {
							t = r[r.length - 1];
							for (
		...
		function (t, e) {
			t.exports = {
				...
				float: function (t, e, n, r) {
					...
					for (
						var a = this.integer(t, e) + ".", o = 0, u = this.natural(n, r);
						o < u;
						o++
					)
						a +=
		...
		function (t, e) {
			...
			t.exports = {
				...
				date: function (t) {
					return (
						(t = t || "yyyy-MM-dd"), this._formatDate(this._randomDate(), t)
					);
				},
				time: function (t) {
		...
		function (t, e) {
			t.exports = {
				...
				hex2rgb: function (t) {
					return (
						(t =
							("0x" + t.slice(1).replace(t.length > 4 ? t : /./g, "$&$&")) | 0),
						[t >> 16, (t >> 8) & 255, 255 & t]
					);
				},
			};
		...
		function (t, e, n) {
			...
			t.exports = {
				...
				sentence: function (t, e) {
					for (var n = r(12, 18, t, e), a = [], u = 0; u < n; u++)
						a.push(this.word());
					return o.capitalize(a.join(" ")) + ".";
				},
				csentence: function (t, e) {
					for (var n = r(12, 18, t, e), a = [], o = 0; o < n; o++)
						a.push(this.cword());
					return a.join("") + "。";
				},
				word: function (t, e) {
					for (var n = r(3, 10, t, e), o = "", u = 0; u < n; u++)
						o += a.character("lower");
					return o;
				},
		...
		function (t, e, n) {
			...
			t.exports = {
				...
				shuffle: function (t, e, n) {
					t = t || [];
					for (
						var r = t.slice(0), a = [], o = 0, u = r.length, i = 0;
						i < u;
						i++
					)
		...
		function (t, e) {
			t.exports = {
				...
				name: function (t) {
					return (
						this.first() + " " + (t ? this.first() + " " : "") + this.last()
					);
				},
				cfirst: function () {
					var t =
		...
		function (t, e, n) {
			...
			t.exports = {
				...
				id: function () {
					...
					t =
						this.pick(r).id + this.date("yyyyMMdd") + this.string("number", 3);
					...
					function g(t) {
						...
						function y(e) {
							...
							return (
								tr !== e &&
									(tr > e &&
										((tr = 0), (er = { line: 1, column: 1, seenCR: !1 })),
									n(er, tr, e),
									(tr = e)),
								er
							);
						...
						if ("startRule" in bt) {
							if (!(bt.startRule in wt))
								throw new Error(
									"Can't start parsing from rule \"" + bt.startRule + '".'
								);
							Ct = wt[bt.startRule];
						}
						if (
						...
						for (var r, a = h, u = 0; u < t.body.length; u++)
							switch (((r = t.body[u]), r.type)) {
								...
								default:
									var s = f[r.text];
									if (s)
										for (var p = 0; p <= s.length; p++) a = a.replace(s[p], "");
							}
		...
		function (t, e, n) {
			function r(t, e, n) {
				...
				switch (
					((i.path = n.slice(0)),
					i.path.push(void 0 === e ? "ROOT" : i.name),
					i.type)
				) {
					case "array":
						(i.items = []),
			...
			var a = n(2),
				...
				i = {
					...
					name: function (t, e, n, r) {
						var a = r.length;
						return (
							l.equal("name", t.path, n + "", t.name + "", r), r.length === a
						);
					},
					type: function (t, e, n, r) {
						...
						return (
							l.equal("type", t.path, o.type(e), t.type, r), r.length === u
						);
					},
					value: function (t, e, n, r) {
						...
						if (!u.parameters) {
							switch (i) {
								case "regexp":
									return (
										l.match("value", t.path, e, t.template, r), r.length === o
									);
								case "string":
						...
						switch (i) {
							...
							case "regexp":
								(c = e.match(
									new RegExp(t.template.source.replace(/^\^|\$$/g, ""), "g")
								)),
									(c = c ? c.length : 0),
									void 0 !== u.min &&
										void 0 !== u.max &&
							...
							if (t.rule.parameters) {
								if (
									...
									l.equal(
										...
										t.path,
										e.length,
										o.min * t.items.length,
										r
									);
								}
								if (o.parameters[2]) return r.length === a;
							} else
								l.equal("items length", t.path, e.length, t.items.length, r);
		...
		function (t, e, n) {
			...
			function o(t) {
				...
				for (var n in r.Mock._mocked) {
					...
					if (
						(!a.rurl || e(a.rurl, t.url)) &&
						(!a.rtype || e(a.rtype, t.type.toLowerCase()))
					)
						return a;
				}
			}
			function u(t, e) {
				return i.isFunction(t.template)
					? t.template(e)
					: r.Mock.mock(t.template);
			}
			var i = n(3);
			...
			(r._settings = { timeout: "10-100" }),
				...
				i.extend(r.prototype, {
					...
					send: function (t) {
						function e() {
							(n.readyState = r.HEADERS_RECEIVED),
								...
								(n.response = n.responseText =
									JSON.stringify(
										u(n.custom.template, n.custom.options),
										null,
										4
									)),
								(n.readyState = r.DONE),
						...
						var n = this;
						if (!this.match) this.custom.xhr.responseType = this.responseType;
						return (
							...
							this.match
								? (this.setRequestHeader(
								  ...
								  void (this.custom.async
										? setTimeout(e, this.custom.timeout)
										: e()))
